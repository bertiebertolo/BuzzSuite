...
class resting_tracker():
    ...
    def __init__(self,settings_track, assignment="greedy", motion_model="none"):
        self.nextObjectID = 0
        ...
        # WS3: resting tracker historically gates new objects by maxdisttracking; keep that.
        self.maxdistnewobject = settings_track.get("maxdistnewobject", self.maxdisttracking)
